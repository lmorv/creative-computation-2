...
Experiments in class using AI and the computer's camera.

* Handpose
  * Hand gestures?
* ObjectDetector
  * Working with confidence percentages
  * Can you get data from extremely low confidence detection?
* Blinking
* Machine Learning stuff outside the webcam (TensorFlow).
